 ...
 */
@Entity
@Table(name = "t_rolepermissionmap")
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@DynamicInsert
@DynamicUpdate
public class RolePermissionMapPo extends SuperPersistentObject {
    ...
    /**
     * @return 获取的rolePermissionMapId
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "RolePermissionMapId")
    public final Long getRolePermissionMapId() {
        return rolePermissionMapId;
    }

    /**
     * 设置rolePermissionMapId的方法.
     * 
     * @param rolePermissionMapId
     *            赋值给rolePermissionMapId的值
     */
    public final void setRolePermissionMapId(final Long rolePermissionMapId) {
